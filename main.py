...
with fil1:
  ...
  fil1.metric(label='NO OF MISSIONS',value=k1['Mission'].sum(),delta=int(k1['Mission'].sum()))
with fil2:
...
with fil3:
  ...
  fil3.metric(label='NO OF MISSIONS',value=k2['Mission'].sum(),delta=int(k2['Mission'].sum()))
